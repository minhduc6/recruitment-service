...
public class EmployerServiceTest {
  ...
  // @InjectMocks
  // private EmployerServiceImple employerService; // Assuming this is the class containing
  // createEmployer method
  ...
  //     CreateEmployerRequest request = new CreateEmployerRequest("newemail@example.com", "Employer
  // Name", 1, "Description");
  //     when(employerRepository.existsEmployerByEmail(request.getEmail())).thenReturn(false);
  //     when(provinceRepository.findById(request.getProvinceId())).thenReturn(Optional.of(new
  // Province()));
  ...
  //     // Mocking
  //     CreateEmployerRequest request = new CreateEmployerRequest("existingemail@example.com",
  // "Employer Name", 1, "Description");
