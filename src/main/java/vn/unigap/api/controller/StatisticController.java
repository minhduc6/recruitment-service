...
public class StatisticController {
    ...
    public ResponseWrapper<StatisticTheSystemDTO> getStatisticTheSystemByDay(@RequestParam @NotNull String fromDate , @RequestParam @NotNull  String toDate) {
        try {
            ...
            StatisticTheSystemDTO result = statisticService.generalIndexOfTheSystemByDay(fromDate,toDate);
            logger.info("Returning response GET /theSystemByDay?fromDate={}, toDate={} {}", fromDate, toDate , result);
