...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseWrapper<JwtAuthenticationResponse> login(@Valid @RequestBody SigninRequest signinRequest) {
    ...
    public ResponseWrapper<JwtAuthenticationResponse> register(@Valid @RequestBody SignUpRequest signUpRequest) {
        ...
        return new ResponseWrapper<>(0, HttpStatus.OK.value(), "Register Success successfully", response);
    }
}
